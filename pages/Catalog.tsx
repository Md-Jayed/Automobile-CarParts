...
import { Filter, Grid, List, Check, Star, Car, Package, ShoppingCart, AlertCircle } from 'lucide-react';
  ...
  <div className="group bg-white rounded-[2.5rem] border border-slate-200 overflow-hidden hover:shadow-2xl transition-all duration-500 flex flex-col">
    ...
    <div className="p-8 flex-1 flex flex-col">
      ...
      <div className="flex items-center justify-between mt-auto pt-6 border-t border-slate-50">
        ...
        <button className="bg-red-600 hover:bg-red-700 text-white p-4 rounded-2xl transition-all shadow-lg shadow-red-200">
...
const ProductListItem: React.FC<{ product: Product }> = ({ product }) => (
  <div className="group bg-white rounded-[2.5rem] border border-slate-200 p-6 flex flex-col md:flex-row gap-8 hover:shadow-2xl transition-all">
    <Link to={`/product/${product.id}`} className="w-full md:w-56 h-56 flex-shrink-0 bg-slate-50 rounded-3xl overflow-hidden">
    ...
    <div className="flex-1 py-2 flex flex-col">
      ...
      <div className="mt-auto flex justify-between items-center pt-8">
        ...
        <div className="flex gap-4">
          ...
          <button className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-2xl font-black text-sm transition-all shadow-lg shadow-red-200 flex items-center gap-2">
